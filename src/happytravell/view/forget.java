...
public class forget extends javax.swing.JFrame {
    ...
    String newPassword = new String(resetPassword.getPassword());
    String confirmPass = new String(confirmPassword.getPassword());

    if (email.isEmpty() || code.isEmpty() || newPassword.isEmpty() || confirmPass.isEmpty()) {
        javax.swing.JOptionPane.showMessageDialog(this, "Please fill all fields.");
        return;
    }

    // Simulate verification code (static for now)
    String expectedCode = "123456";

    if (!code.equals(expectedCode)) {
        javax.swing.JOptionPane.showMessageDialog(this, "Invalid verification code.");
        return;
    }
    ...
    boolean found = false;
    for (Map<String, String> user : happytravell.controller.Importedclasses.users) {
        if (user.get("email").equalsIgnoreCase(email)) {
            user.put("password", newPassword); // Not secure, but fine for demo
            found = true;
    ...
    if (!found) {
        javax.swing.JOptionPane.showMessageDialog(this, "No user found with that email.");
    }
    ...
    private void showButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showButtonActionPerformed
        ...
        if (confirmPassword.getEchoChar() == '•' || confirmPassword.getEchoChar() == '*') {
        confirmPassword.setEchoChar((char) 0); // Show password
        show1Button.setText("Hide");
    } else {
