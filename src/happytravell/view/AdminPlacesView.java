...
public class AdminPlacesView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 150, 50));
        ...
        addPlacesButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        addPlacesButton.setText("Add Places");
        TravelerDetailsPanel.add(addPlacesButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 60, 110, 30));

        backButton.setBackground(new java.awt.Color(252, 186, 107));
        backButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        backButton.setText("Back");
        TravelerDetailsPanel.add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 64, 70, 25));

        searchIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/search.png"))); // NOI18N
        TravelerDetailsPanel.add(searchIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 65, 25, 20));

        searchField.setBackground(new java.awt.Color(252, 186, 107));
        searchField.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        searchField.setText("Search");
        TravelerDetailsPanel.add(searchField, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 60, 210, 30));
